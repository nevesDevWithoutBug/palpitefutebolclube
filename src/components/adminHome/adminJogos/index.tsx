                        ...
                        return (
                            <li key={key} className={style.liPalpite}>
                                <div className={style.contentContainer}>
                                    ...
                                    <input disabled={editar !== key} className={editar ===key ? style.inputPalpite : style.inputPalpiteDisabled} value={inputValue} onChange={handleInputChange}></input>
                                    ...
                                    <input disabled={editar !== key} className={editar === key ? style.inputPalpite : style.inputPalpiteDisabled}></input>
                                    <span className={style.spanPalpiteTime}>
